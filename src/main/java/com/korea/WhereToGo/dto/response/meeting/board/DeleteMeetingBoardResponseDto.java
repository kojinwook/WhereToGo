...
@Getter
public class DeleteMeetingBoardResponseDto extends ResponseDto {

    public DeleteMeetingBoardResponseDto(){
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<? super DeleteMeetingBoardResponseDto> success(){
        DeleteMeetingBoardResponseDto responseBody = new DeleteMeetingBoardResponseDto();
